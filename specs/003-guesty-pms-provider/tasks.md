...
- [ ] T032 [US1] Register GuestyProvider in provider registry and implement test_connection via get_listings() success check (verify authenticated request succeeds; surface zero listings as warning, not failure) in src/providers/guesty/__init__.py and src/providers/registry.py
